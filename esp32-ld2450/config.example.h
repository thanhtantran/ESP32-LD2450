...
// ---------------------------------------------------------------
// Quan sát thực tế: X luôn hợp lý (vài trăm mm), nhưng Y luôn ra một số
// âm rất lớn quanh -32000 đến -32768 — dấu hiệu kinh điển của lỗi giải
// mã 16-bit: giá trị đúng phải là (raw uint16) - 32768, nhưng thư viện
// lại trả nguyên giá trị đó dưới dạng int16_t có dấu. Bật cờ này để tự
// sửa lại target.y trước khi dùng (in log, tính zone, gửi WebSocket,
